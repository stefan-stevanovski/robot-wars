...
//
// RobotMeshNode::RobotMeshNode					- Chapter X, page Y 
//
D3DRobotMeshNode9::D3DRobotMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
...
//
// RobotMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DRobotMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
	...
	//Rotate the Robot 90 degrees from default so that the spout faces forward
	Mat4x4 rotateY90;
