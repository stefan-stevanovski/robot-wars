...
////////////////////////////////////////////////////
//
// class RobotMeshNode9				- Chapter X, page Y
//
////////////////////////////////////////////////////

class D3DRobotMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DRobotMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};
...
class D3DRobotMeshNode11 : public D3DShaderMeshNode11
{
public:
	D3DRobotMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass,const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\Robot.sdkmesh", renderPass, t) { }
