//========================================================================
// RobotWars.cpp : source file for the sample game
//
...
#include "RobotWars.h"
#include "RobotWarsView.h"
#include "RobotWarsNetwork.h"
#include "RobotEvents.h"
#include "RobotResources.h"


RobotWarsApp g_RobotWarsApp;
...
//========================================================================
//
// RobotWarsApp Implementation     - Chapter 21, page 722
//
//========================================================================
...
//
// RobotWarsApp::VCreateGameAndView
//
BaseGameLogic *RobotWarsApp::VCreateGameAndView()
{
	m_pGame = GCC_NEW RobotWarsLogic();
    m_pGame->Init();
...
HICON RobotWarsApp::VGetIcon()
{
	return LoadIcon(GetInstance(), MAKEINTRESOURCE(IDI_ICON1));
}

void RobotWarsApp::VRegisterGameEvents(void)
{
...
void RobotWarsApp::VCreateNetworkEventForwarder(void)
{
...
void RobotWarsApp::VDestroyNetworkEventForwarder(void)
{
...
//========================================================================
//
// RobotWarsLogic Implementation       - Chapter 21, page 725
//
//========================================================================

//
// RobotWarsLogic::RobotWarsLogic
//
RobotWarsLogic::RobotWarsLogic()
{
...
//
// RobotWarsLogic::VChangeState
//
void RobotWarsLogic::VChangeState(BaseGameState newState)
{
	...
	switch(newState)
	{
		case BGS_WaitingForPlayers:
		{
			...
			{
				shared_ptr<IGameView> playersView(GCC_NEW RobotWarsHumanView(g_pApp->m_Renderer));
			...
			{
				shared_ptr<IGameView> aiView(GCC_NEW AIRobotView(m_pPathingGraph));
				VAddView(aiView);
			}
			break;
		}
		...
		case BGS_SpawningPlayersActors:
		{
			...
			for (auto it = m_gameViews.begin(); it != m_gameViews.end(); ++it)
			{
				...
				{
					shared_ptr<AIRobotView> pAiView = static_pointer_cast<AIRobotView, IGameView>(pView);
...
//
// RobotWarsLogic::VAddView
//
void RobotWarsLogic::VAddView(shared_ptr<IGameView> pView, ActorId actor)
{
...
//	}
	if (dynamic_pointer_cast<RobotWarsHumanView>(pView))
	{
		m_HumanPlayersAttached++;
	}
	else if (dynamic_pointer_cast<AIRobotView>(pView))
	{
		m_AIPlayersAttached++;
	}
}
...
void RobotWarsLogic::VMoveActor(const ActorId id, Mat4x4 const &mat)
{
...
void RobotWarsLogic::RequestStartGameDelegate(IEventDataPtr pEventData)
{
	VChangeState(BGS_WaitingForPlayers);
}

void RobotWarsLogic::EnvironmentLoadedDelegate(IEventDataPtr pEventData)
{
    ++m_HumanGamesLoaded;
}


// FUTURE WORK - this isn't RobotWars specific so it can go into the game agnostic base class
void RobotWarsLogic::RemoteClientDelegate(IEventDataPtr pEventData)
{
...
void RobotWarsLogic::NetworkPlayerActorAssignmentDelegate(IEventDataPtr pEventData)
{
	if (!m_bProxy)
		return;
	...
	for (auto it = m_gameViews.begin(); it != m_gameViews.end(); ++it)
    {
        ...
        if (pView->VGetType() == GameView_Human)
        {
            shared_ptr<RobotWarsHumanView> pHumanView = static_pointer_cast<RobotWarsHumanView, IGameView>(pView);
...
void RobotWarsLogic::StartThrustDelegate(IEventDataPtr pEventData)
{
...
void RobotWarsLogic::EndThrustDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RobotWarsLogic::StartSteerDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RobotWarsLogic::EndSteerDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RobotWarsLogic::TestScriptDelegate(IEventDataPtr pEventData)
{
...
void RobotWarsLogic::RegisterAllDelegates(void)
{
	// FUTURE WORK: Lots of these functions are ok to go into the base game logic!
    IEventManager* pGlobalEventManager = IEventManager::Get();
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::RemoteClientDelegate), EvtData_Remote_Client::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::MoveActorDelegate), EvtData_Move_Actor::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::RequestStartGameDelegate), EvtData_Request_Start_Game::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::NetworkPlayerActorAssignmentDelegate), EvtData_Network_Player_Actor_Assignment::sk_EventType);
	pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::EnvironmentLoadedDelegate), EvtData_Environment_Loaded::sk_EventType);
	pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::EnvironmentLoadedDelegate), EvtData_Remote_Environment_Loaded::sk_EventType);

	// FUTURE WORK: Only these belong in RobotWars.
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::StartThrustDelegate), EvtData_StartThrust::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::EndThrustDelegate), EvtData_EndThrust::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::StartSteerDelegate), EvtData_StartSteer::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::EndSteerDelegate), EvtData_EndSteer::sk_EventType);

    pGlobalEventManager->VAddListener(MakeDelegate(this, &RobotWarsLogic::TestScriptDelegate), EvtData_ScriptEventTest_FromLua::sk_EventType);
}

void RobotWarsLogic::RemoveAllDelegates(void)
{
	// FUTURE WORK: See the note in RegisterDelegates above....
    IEventManager* pGlobalEventManager = IEventManager::Get();
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::RemoteClientDelegate), EvtData_Remote_Client::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::MoveActorDelegate), EvtData_Move_Actor::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::RequestStartGameDelegate), EvtData_Request_Start_Game::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::NetworkPlayerActorAssignmentDelegate), EvtData_Network_Player_Actor_Assignment::sk_EventType);
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::EnvironmentLoadedDelegate), EvtData_Environment_Loaded::sk_EventType);
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::EnvironmentLoadedDelegate), EvtData_Remote_Environment_Loaded::sk_EventType);
	if (m_bProxy)
	{
	    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::RequestNewActorDelegate), EvtData_Request_New_Actor::sk_EventType);
	}

	// FUTURE WORK: These belong in Robot wars!
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::StartThrustDelegate), EvtData_StartThrust::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::EndThrustDelegate), EvtData_EndThrust::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::StartSteerDelegate), EvtData_StartSteer::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::EndSteerDelegate), EvtData_EndSteer::sk_EventType);

    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RobotWarsLogic::TestScriptDelegate), EvtData_ScriptEventTest_FromLua::sk_EventType);
}

void RobotWarsLogic::CreateNetworkEventForwarder(const int socketId)
{
...
void RobotWarsLogic::DestroyAllNetworkEventForwarders(void)
{
...
bool RobotWarsLogic::VLoadGameDelegate(TiXmlElement* pLevelData)
{
    RegisterRobotScriptEvents();
    return true;
}
