#pragma once
//========================================================================
// RobotWars.h : source file for the sample game
//
...
//---------------------------------------------------------------------------------------------------------------------
// RobotWarsApp class                          - Chapter 21, page 722
// Note: Don't put anything in this class that needs to be destructed
//---------------------------------------------------------------------------------------------------------------------
class RobotWarsApp : public GameCodeApp
{
protected:
	virtual BaseGameLogic *VCreateGameAndView();

public:
	virtual TCHAR *VGetGameTitle() { return _T("Robot Wars"); }
	virtual TCHAR *VGetGameAppDirectory() { return _T("Game Coding Complete 4\\Robot Wars\\4.0"); }
...
//---------------------------------------------------------------------------------------------------------------------
// RobotWarsLogic class                        - Chapter 21, page 723
//---------------------------------------------------------------------------------------------------------------------
class RobotWarsLogic : public BaseGameLogic
{
protected:
