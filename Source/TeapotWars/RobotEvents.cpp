//========================================================================
// RobotEvents.cpp : defines game-specific events for RobotWars
//
...
// Note: these are game specific events, which really should be in RobotEvents.cpp.
// They aren't because of an annoying dependancy in Network.cpp, which creates events
// from a bitstream. Once we get "real" streaming code in we can move these back to RobotEvents.cpp.
...
void RegisterRobotScriptEvents(void)
{
