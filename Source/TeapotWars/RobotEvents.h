#pragma once
//========================================================================
// RobotEvents.h : defines game-specific events for RobotWars
//
...
// Nasty game dependent events here. We'll move this back into game specific RobotEvents.h when real streaming code 
